...
export default {
    actions: {
        ...
        [UserController.listCurrentUserFunctions.method] : {
            summary: '获取当前用户的所有可用的功能',
            method: 'get',
            url: (payload) => `/api/users/functions`,
            parameters: [],
        },
        [UserController.listCurrentUserMenus.method] : {
            summary: '获取当前用户的所有菜单',
            method: 'get',
        ...
        [UserController.listUserFunctionCodes.method] : {
            ...
            method: 'get',
            url: (payload) => `/api/users/${payload.id}/function-codes`,
            parameters: [{'name':'id','in':'path','description':'id','required':true,'type':'string'}],
        },
        [UserController.listUserFunctions.method] : {
            summary: '获取用户的所有可用的功能',
            method: 'get',
            url: (payload) => `/api/users/${payload.id}/functions`,
            parameters: [{'name':'id','in':'path','description':'id','required':true,'type':'string'}],
        },
        [UserController.listUserMenus.method] : {
            summary: '获取用户的所有菜单',
            method: 'get',
            url: (payload) => `/api/users/${payload.id}/menus`,
            parameters: [{'name':'id','in':'path','description':'id','required':true,'type':'string'}],
        },
